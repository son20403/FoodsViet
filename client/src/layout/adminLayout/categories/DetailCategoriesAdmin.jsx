...
const DetailCategoriesAdmin = ({
  ...
  // console.log("🚀 ~ file: DetailCategoriesAdmin.jsx:39 ~ posts:", posts);
  const dataPostsByCategory = posts.filter(
    (post) => post.category === data?._id
  );
  console.log(
    "🚀 ~ file: DetailCategoriesAdmin.jsx:40 ~ dataPostsByCategory:",
    dataPostsByCategory
  );
        ...
        <LayoutAdminModel onClick={onClick}>
          ...
          >
            <div className="absolute inset-0 bg-black bg-opacity-60">
              <div
                className="page-content px-5 mt-3 lg:px-10 flex flex-col h-full text-white flex-1
              ...
              >
                ...
                <div className="text-white text-xs md:text-sm lg:text-sm uppercase opacity-80  mt-10 flex ">
                  <div className="px-2 border-r last:border-none">
                    {customers?.full_name}
                  </div>
                  <div className="px-2 border-r last:border-none">
                    {data?.date}{" "}
