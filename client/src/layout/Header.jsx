    ...
    return (
        ...
        ${isScroll ? 'bg-white text-black shadow-3xl' : 'md:text-white'}`}>
            ...
            <div className='page-content relative px-2 md:px-3 lg:px-2 flex items-center py-2 justify-between'>
                ...
                <Setting></Setting>
                <div className='flex items-center gap-3 lg:gap-7  z-[10]'>
                    ...
                    <div onClick={handleToggleNotification} className='cursor-pointer'>
                        {notificationIsActive > 0 ? <Badge content={notificationIsActive} overlap="circular">
                            <div className={`p-3 border border-current rounded-full
                        ${isScroll ? ' !text-black ' : ' !text-white'}`}>
                                <BellIcon className="h-4 w-4 " />
                            </div>
                        </Badge> : <div className={`p-3 border border-current rounded-full
                        ${isScroll ? ' !text-black ' : ' !text-white'}`}>
                            <BellIcon className="h-4 w-4 " />
                        </div>}
                    </div>
